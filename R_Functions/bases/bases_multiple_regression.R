...
mult_regression <- data.frame(zip = distance$zip, peak_date = distance$peak, distance_black = distance$black_dist, distance_red = distance$red_dist, sh = NA, school = as.Date(NA), 
